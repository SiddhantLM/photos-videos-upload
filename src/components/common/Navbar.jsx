...
const Navbar = () => {
  ...
  return (
    <div className="absolute top-0 left-0 z-30   bg-[#FFFFF0]  w-full h-[3.5rem] ">
      {sideMenu ? (
        <SideMenu sideMenuHandler={sideMenuHandler} />
      ) : (
        <div>
          <div className="md:w-9/12 p-2 flex mx-auto items-center justify-between mt-2">
            ...
            <div
              className="md:hidden py-2 bg-white p-2 flex justify-center items-center rounded-md border-2 border-[#388087]"
